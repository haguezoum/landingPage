  ...
  >
    ...
    >
      <div
        ...
        :key="index"
        :class="
          plan.title === 'BEST Value' ? 'border border-purple-900  active' : ''
        "
      >
        <header
        ...
        >
          <p
            class="planTitle py-2 text-white uppercase font-semibold"
            :class="plan.title !== 'BEST Value' ? 'text-green-600' : ''"
          >
            {{ plan.title }}
          </p>
          <p
