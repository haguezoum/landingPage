                    ...
                    <section 
                      ...
                      <div class="user text-center  sm:w-1/3 sm:mt-5 transform ease-in-out delay-500 ">
                        ...
                        <div class="mt-12  sm:w-2/3 duration">
                          <p class="text-lg text-white w-full px-2">{{currentSlider.content}}</p>
                        </div>
                    </section> 
                  </transition>
...
export default {
  ...
  data() {
    return {
      icons: [
        { name: "icone 1", iconPath: "/img/icone-1.png", title: "icone totle" , delay:1000 },
        { name: "icone 2", iconPath: "/img/icone-2.png", title: "icone totle" , delay:2000 },
        { name: "icone 3", iconPath: "/img/icone-3.png", title: "icone totle" , delay:3000 },
        { name: "icone 4", iconPath: "/img/icone-4.png", title: "icone totle" , delay:4000 },
        { name: "icone 5", iconPath: "/img/icone-6.png", title: "icone totle" , delay:5000 },
        { name: "icone 6", iconPath: "/img/icone-5.png", title: "icone totle" , delay:6000 },
        { name: "icone 7", iconPath: "/img/icone-6.png", title: "icone totle" , delay:7000 },
        { name: "icone 8", iconPath: "/img/icone-1.png", title: "icone totle" , delay:8000 },
        { name: "icone 9", iconPath: "/img/icone-2.png", title: "icone totle" , delay:9000 },
      ],
      sliderInfo:[
        {
          ...
          content:'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dicta, animi.'
        },
        {
          avatar:'/img/customer/2.jpg',
          name:'DevEd',
          job:'fron-end developer',
          content:' sit amet consectetur adipisicing elit. Dicta, animi  sit amet consectetur adipisicing elit. Dicta, animi'
        },
        {
  ...
  methods:{
    ...
    next(){
      this.slidIndex <= this.sliderInfo.length? this.slidIndex ++ : this.slidIndex --
    },
    prev(){
      this.slidIndex >= this.sliderInfo.length? this.slidIndex -- : this.slidIndex ++
    }
